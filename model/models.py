...
class ConvolutionalBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, batch_norm=False, activation=None):
        ...
        if activation is not None:
            ...
            assert activation in {'prelu', 'leakyrelu', 'tanh', 'relu','sigmoid'}
...
class SubPixelConvolutionalBlock(nn.Module):
    ...
    def __init__(self, kernel_size=3, n_channels=64, scaling_factor=1):
        """
...
class SRResNet(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=16):
        ...
        self.conv_block1 = ConvolutionalBlock(in_channels=1, out_channels=n_channels, kernel_size=large_kernel_size,
                                              stride=1, batch_norm=False, activation='PReLu')
    ...
    def forward(self, lr_imgs):
        ...
        output = self.conv_block2(output)       # (N, n_channels, w, h)
        output = output + residual              # (N, n_channels, w, h)
        sr_imgs = self.conv_block3(output)      # (N, 1, w, h)
...
class TruncatedVGG19(nn.Module):
    ...
    def forward(self, input):
        ...
        """
        output = self.truncated_vgg19(input.repeat(1, 3, 1, 1))  # (N, feature_map_channels, feature_map_w, feature_map_h)
